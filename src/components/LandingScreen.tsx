...
import { Sparkles, Music, Star, ChevronLeft } from 'lucide-react';
      ...
      {!isExiting && (
        ...
        >
          ...
          <div className="relative max-w-lg w-full text-center px-6 py-12 rounded-3xl glass-card animate-glow border-emerald-500/30 flex flex-col items-center">
            ...
            <Star className="absolute top-6 left-6 text-emerald-400 w-5 h-5 animate-spin" style={{ animationDuration: '8s' }} />
            <Star className="absolute bottom-6 right-6 text-sky-400 w-5 h-5 animate-spin" style={{ animationDuration: '6s' }} />
            ...
            <motion.div
              ...
              className="relative w-24 h-24 rounded-full bg-gradient-to-tr from-emerald-600/30 to-sky-600/30 border border-emerald-400/30 flex items-center justify-center mb-8 shadow-[0_0_20px_rgba(16,185,129,0.2)]"
            >
              <Music className="w-10 h-10 text-sky-300 animate-bounce" />
            ...
            >
              جشن تولد <span className="text-gradient">مهشید</span> عزیزمون ✨
            </motion.h1>
            ...
            >
              به دنیای جادویی، پر از رنگ‌های زیبای سبز بهار و آبی آسمان خوش آمدید. برای شنیدن ترانه تولد و ورود به تالار جشن، دکمه ورود زیر را بفشارید!
            </motion.p>
            ...
            <motion.button
              ...
              onClick={handleStart}
              className="relative group px-8 py-4 bg-gradient-to-r from-emerald-500 to-sky-500 rounded-full text-white font-sans font-bold text-lg cursor-pointer shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_40px_rgba(14,165,233,0.6)] border border-emerald-400/20 overflow-hidden flex items-center gap-3"
            >
