...
define('DB_USER', 'easydri1_Task');              // نام کاربری دیتابیس در سی‌پنل
define('DB_PASS', '09386561626mM@');                  // کلمه عبور دیتابیس در سی‌پنل
define('DB_NAME', 'easydri1_Task');  // نام دیتابیس ساخته شده در سی‌پنل
...
// رمز عبور مدیریت به صورت هاردکد شده طبق درخواست کاربر
